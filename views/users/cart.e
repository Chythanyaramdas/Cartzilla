      ...
      <div class="container pb-5 mb-2 mb-md-4">
        <div class="row">
          ...
          <section class="col-lg-8">
            ...
            <!-- Item-->
           <% for(i=0;i<userData.cart.item.length;i++){%>
            <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
              <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="/shopSingle?id=<%=userData.cart.item[i].productId %>"  ><img src="/img/marketplace/products/<%=userData.cart.item[i].image%>" width="160" alt="Product"></a>
                <div class="pt-2">
                  <h3 class="product-title fs-base mb-2"><a href=""></a></h3>
                  ...
                  <div class="fs-lg text-accent pt-2"><%= userData.cart.item[i].price %><small>00</small></div>
                </div>
              </div>
              <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                <label class="form-label" for="quantity1"><%= userData.cart.item[i].quantity %></label>
            ...
            <!-- <div class="d-sm-flex justify-content-between align-items-center my-2 pb-3 border-bottom">
              <div class="d-block d-sm-flex align-items-center text-center text-sm-start"><a class="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="/shopSingle?id="><img src="/img/marketplace/products/" width="160" alt="Product"></a>
                <div class="pt-2">
                  ...
                  <div class="fs-lg text-accent pt-2"><small>50</small></div>
                </div>
              </div>
              <div class="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-start" style="max-width: 9rem;">
                <label class="form-label" for="quantity2"></label>
            ...
            <div class="bg-white rounded-3 shadow-lg p-4">
              <div class="py-2 px-xl-2">
                <div class="text-center mb-4 pb-3 border-bottom">
                  ...
                  <h3 class="fw-normal"><%=userData.cart.totalPrice%><small></small></h3>
                </div>
                <div class="mb-3 mb-4">
